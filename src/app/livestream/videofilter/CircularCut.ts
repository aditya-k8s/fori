...
export default class CircularCut implements VideoFrameProcessor {
  private targetCanvas:any | HTMLCanvasElement = document.createElement('canvas') as HTMLCanvasElement;
  private targetCanvasCtx:any| CanvasRenderingContext2D = this.targetCanvas.getContext(
    '2d'
